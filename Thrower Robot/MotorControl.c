...
void LMForward(u16 a){motor_control(LMotor,1200-a + 10,1);}
void RMForward(u16 a){motor_control(RMotor,1200-a + 10,1);}
void LMBackward(u16 a){motor_control(LMotor,1200-a - 10,0);}
void RMBackward(u16 a){motor_control(RMotor,1200-a - 10,0);}
